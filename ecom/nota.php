 	...
 	<div class="row">
 		<div class="col-md-7">
 			<div class="alert alert-info">
 				<p>
					Total Belanjaan Anda Rp.<?php echo number_format($total_biaya); ?>
					<br>
					Ongkos Kirim Rp.<?php echo number_format($detail['subtarif']); ?>
					<br>
					<br>
 					Silahkan melakukan pembayaran Rp. <?php echo number_format($detail['total_pembelian']); ?> ke <br>
 					<strong>BANK Mandiri 0123456789 AN. Yulius Adrian</strong>
					<br>
					<br>
					Screenshot halaman ini sebagai bukti pesanan anda.
